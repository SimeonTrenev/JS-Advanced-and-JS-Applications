function solveClasses() {
    ...
    class Dog extends Pet {
        ...
        toString() {
            let dogMessage = [super.toString()];
            dogMessage.push(`Main information:`)
            dogMessage.push(`${this.name} is a dog with need of ${this.runningNeeds}km running every day and ${this.trainability} trainability.`)
            
            return dogMessage.join('\n')
        }
    }
    return { Pet, Cat, Dog}
}
